...
var crypto = require('crypto');// access Node.js Crypto library for signature generation
var request = require('request');// use request or request-promise to call into STATS API
var connection = require('../../db/connect');

// calc_players_points_in_match 
module.exports = function (match_ApiId, callback4) {
    var players = [];
    var values = [];
                    ...
                    function (err, response, body) {
                        ...
                        getInjury(function () {
                            ...
                            if (players[i].Position == 'M') {
                                point += (goals * 5);
                                if (j.outcome.opponentTeamScore == 0)
                                    point++;
                            }
